...
const prepublish = async () => {
    try {
        ...
        console.warn('Warning: Failed to download microbit hex file. This is not critical for development.');
        ...
        fs.writeFileSync(
            ...
            [
                '// This file is generated by scripts/prepublish.mjs',
                '// Placeholder due to network failure during prepublish',
                'module.exports = null;',
                ''
            ].join('\n')
        );
        console.info(`Created placeholder ${relativeGeneratedFile}`);
    }
};
