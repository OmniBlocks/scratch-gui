...
import PaintEditorFullscreen from '../../containers/paint-editor-fullscreen.jsx';
    ...
    return (<MediaQuery minWidth={unconstrainedWidth}>{isUnconstrained => {
        ...
        const alwaysEnabledModals = (
            <React.Fragment>
                ...
                {paintEditorFullscreenVisible && <PaintEditorFullscreen />}
            </React.Fragment>
        );
...
GUIComponent.propTypes = {
    ...
    paintEditorFullscreenVisible: PropTypes.bool,
