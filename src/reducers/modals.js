...
const MODAL_PAINT_EDITOR_FULLSCREEN = 'paintEditorFullscreen';
...
const initialState = {
    ...
    [MODAL_PAINT_EDITOR_FULLSCREEN]: false
};
...
const openPaintEditorFullscreen = function () {
    return openModal(MODAL_PAINT_EDITOR_FULLSCREEN);
};
...
const closePaintEditorFullscreen = function () {
    return closeModal(MODAL_PAINT_EDITOR_FULLSCREEN);
};
export {
    reducer as default,
